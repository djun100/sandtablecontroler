package cn.yakang.controler.widget.slidingMenu;
...
import cn.yakang.controler.widget.slidingMenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		final int secondContentWidth = getChildMeasureSpec(widthMeasureSpec, 0, width-mWidthOffset);
		final int contentHeight = getChildMeasureSpec(heightMeasureSpec, 0, height);
		mContent.measure(contentWidth, contentHeight);
		if (mSecondaryContent != null){
			mSecondaryContent.measure(secondContentWidth, contentHeight);
		}
	}
